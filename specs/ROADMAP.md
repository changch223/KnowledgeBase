...
- **spec 019 修正 (一部完了)**: 「もう一度見る」→「ガイドを見直す」 + description に Safari 推奨追記済 (2026-05-06)。残: Setup Guide Step 1-3 内容刷新 (Chrome x-callback-url が「現在のタブ URL」を返せない制約への現実的案内、Safari 推奨フロー実機検証後に判断)
